...
class ImageFiducialDetections {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.detections.forEach((val) => {
      bufferOffset = FiducialDetection.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ImageFiducialDetections(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.detections[i] = FiducialDetection.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.detections.forEach((val) => {
      length += FiducialDetection.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ImageFiducialDetections(null);
    ...
    if (msg.detections !== undefined) {
      ...
      for (let i = 0; i < resolved.detections.length; ++i) {
        resolved.detections[i] = FiducialDetection.Resolve(msg.detections[i]);
      }
    }
    else {
      resolved.detections = []
...
module.exports = ImageFiducialDetections;
