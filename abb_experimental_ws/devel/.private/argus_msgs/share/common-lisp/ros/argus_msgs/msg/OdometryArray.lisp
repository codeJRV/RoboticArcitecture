...
(cl:defmethod cl:initialize-instance :after ((m <OdometryArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OdometryArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name argus_msgs-msg:<OdometryArray> is deprecated: use argus_msgs-msg:OdometryArray instead.")))
...
(cl:defmethod odometry-val ((m <OdometryArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader argus_msgs-msg:odometry-val is deprecated.  Use argus_msgs-msg:odometry instead.")
  (odometry m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <OdometryArray>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'odometry))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'odometry))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <OdometryArray>) istream)
  ...
  (cl:setf (cl:slot-value msg 'odometry) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'odometry)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<OdometryArray>)))
  ...
  "6b10b9b6946f001bae81f13ec3a09ee3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'OdometryArray)))
  "Returns md5sum for a message object of type 'OdometryArray"
  "6b10b9b6946f001bae81f13ec3a09ee3")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <OdometryArray>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'odometry) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
