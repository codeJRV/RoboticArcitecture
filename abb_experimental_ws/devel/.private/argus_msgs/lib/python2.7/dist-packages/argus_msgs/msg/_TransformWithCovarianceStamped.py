...
"""autogenerated by genpy from argus_msgs/TransformWithCovarianceStamped.msg. Do not edit."""
import sys
...
class TransformWithCovarianceStamped(genpy.Message):
  _md5sum = "eb5865d296e092b071b42b179ac140e1"
  _type = "argus_msgs/TransformWithCovarianceStamped"
...
float64 w
"""
  __slots__ = ['header','transform','covariance']
  _slot_types = ['std_msgs/Header','geometry_msgs/Transform','float64[36]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TransformWithCovarianceStamped, self).__init__(*args, **kwds)
