...
"""autogenerated by genpy from argus_msgs/OdometryArray.msg. Do not edit."""
import sys
...
class OdometryArray(genpy.Message):
  _md5sum = "6b10b9b6946f001bae81f13ec3a09ee3"
  _type = "argus_msgs/OdometryArray"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Array of odometry messages
...
float64 y
float64 z"""
  __slots__ = ['header','odometry']
  _slot_types = ['std_msgs/Header','nav_msgs/Odometry[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OdometryArray, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.odometry)
      buff.write(_struct_I.pack(length))
      for val1 in self.odometry:
        _v1 = val1.header
