...
if("TRUE" STREQUAL "TRUE")
  set(simple_message_SOURCE_PREFIX /home/jrv/Research/Robotic Architecture/abb_experimental_ws/src/industrial_core/simple_message)
  set(simple_message_DEVEL_PREFIX /home/jrv/Research/Robotic Architecture/abb_experimental_ws/devel/.private/simple_message)
  ...
  set(simple_message_INSTALL_PREFIX /home/jrv/Research/Robotic Architecture/abb_experimental_ws/install)
...
if(NOT "/home/jrv/Research/Robotic Architecture/abb_experimental_ws/src/industrial_core/simple_message/include " STREQUAL " ")
  set(simple_message_INCLUDE_DIRS "")
  set(_include_dirs "/home/jrv/Research/Robotic Architecture/abb_experimental_ws/src/industrial_core/simple_message/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_message' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jrv/Research/Robotic Architecture/abb_experimental_ws/src/industrial_core/simple_message/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jrv/Research/Robotic Architecture/abb_experimental_ws/devel/.private/simple_message/lib;/home/jrv/Research/Robotic Architecture/abb_experimental_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(pkg_cfg_extras "/home/jrv/Research/Robotic Architecture/abb_experimental_ws/src/industrial_core/simple_message/cmake/issue46_workaround.cmake")
